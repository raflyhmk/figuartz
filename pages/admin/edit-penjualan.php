              ...
              <div class="card-body">
                <div class="table-responsive">
                  <form enctype="multipart/form-data" method="POST" action="../../config/update.php" class="form-input" >
                    <div class="mb-3">
                      <input type="hidden" name="id_penjualan" value=<?php echo $dataProduk['id_penjualan'];?>>
                      <label for="inputNamaMobil" class="form-label">Status pemesanan</label>
                      <select class="custom-select" name="statusPengiriman">
                        <option disabled selected value="">pilih status pemesanan</option>
                        <option value="terkirim" <?php if ($dataProduk['statusPemesanan'] == 'terkirim') { echo 'selected'; }?>>terkirim</option>
                          <option value="diproses" <?php if ($dataProduk['statusPemesanan'] == 'diproses') { echo 'selected'; }?>>diproses</option>
                      </select>
                    </div>
                    <div class="mb-3">
                      <button type="submit" class="btn btn-primary" name="btn-editPenjualan">Edit</button>
                    </div>
                  </form>               
                </div>
              </div>
