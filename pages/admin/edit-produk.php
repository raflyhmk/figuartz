                  ...
                  <form enctype="multipart/form-data" method="POST" action="../../config/update.php" class="form-input" >
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        name="namaProduk"
                        value="<?php echo $dataProduk['namaProduk'];?>"
                        required
                      />
                    </div>
                    <div class="mb-3">
                      <label for="formFile" class="form-label">Foto produk</label>
                      <input type="file" class="form-control-file" name="fotoProduk" disabled/>
                    </div>
                    <div class="mb-3">
                      <label for="inputMerk" class="form-label">series</label>
                      <input
                        type="text"
                        class="form-control"
                        placeholder="Masukan series produk..."
                        name="series"
                        value="<?php echo $dataProduk['series'];?>"
                        required
                      />
                    </div>
                    <div class="mb-3">
                      <label for="inputMerk" class="form-label">manufacture</label>
                      <input
                        type="text"
                        class="form-control"
                        placeholder="Masukan asal manufacture produk..."
                        name="manufacture"
                        value="<?php echo $dataProduk['manufacture'];?>"
                        required
                      />
                    </div>
                    <div class="mb-3">
                      <label for="inputMerk" class="form-label">tinggi prooduk</label>
                      <input
                        type="text"
                        class="form-control"
                        placeholder="Masukan ukuran tinggi produk..."
                        name="tinggi"
                        value="<?php echo $dataProduk['tinggi'];?>"
                        required
                      />
                    </div>
                    <div class="mb-3">
                      <label for="inputMerk" class="form-label">harga prooduk</label>
                      <input
                        type="text"
                        class="form-control"
                        placeholder="Masukan harga produk..."
                        name="harga"
                        value="<?php echo $dataProduk['harga'];?>"
                        required
                      />
                    </div>
                    <div class="mb-3">
                      <label for="startTime" class="form-label">Status barang</label>
                        <select class="custom-select" name="status">
                          <option selected disabled value="">----pilih status barang----</option>
                          <option value="ready stock" <?php if ($dataProduk['status'] == 'ready stock') { echo 'selected'; }?>>ready stock</option>
                          <option value="pre order" <?php if ($dataProduk['status'] == 'pre order') { echo 'selected'; }?>>pre order</option>
                        </select>
                    </div>
                    <div class="mb-3">
