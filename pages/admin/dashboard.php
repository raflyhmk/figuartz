        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                          <div class="h5 mb-0 font-weight-bold text-gray-800">
                          <?php echo mysqli_num_rows($listProduk);?>
                        </div>
                        </div>
                      </div>
                      <div class="col-auto">
              ...
              <!-- Earnings (Monthly) Card Example -->
              <?php 
              $penjualan = mysqli_query($koneksi, "select totalHarga from penjualan;");
              $total = 0;
              while($hasilPenjualan = mysqli_fetch_array($penjualan)){
                $total += $hasilPenjualan['totalHarga'];
              }
              ?>
              <div class="col-xl-3 col-md-6 mb-4">
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        >
                          Pendapatan sejauh ini
                        </div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                          <?php echo "IDR ", number_format($total); ?>
                        </div>
                      </div>
                      <div class="col-auto">
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; FiguartZ Company 2022</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
